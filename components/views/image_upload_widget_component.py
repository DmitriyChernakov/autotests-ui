...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.preview_image = Image(page=page, locator=f'{identifier}-image-upload-widget-preview-image', name='Preview')
        ...
        self.upload_input = FileInput(page=page, locator=f'{identifier}-image-upload-widget-input', name='Upload input')
